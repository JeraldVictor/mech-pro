...
//     do {
//       if (l.possible) {
//         //good stock on opt component name
// goodStock.push({
//   name: l.name,
//   postInv:
//     l.invqty > l.totalreqqty
...
//         // projValue.push(o.result);
//       } else if (!l.possible && l.result > 0) {
//         //short stock on opt component name
// shortStock.push({
//   name: l.name,
//   postInv:
//     l.invqty > l.totalreqqty
...
// });
//       }
//     } while (sumValve == valveList.qty); //exit the loop soon we attain the full qty for valve, no more dealing with opt components
//     // } else if (!l.possible && l.result == 0) {
...
//   if (o.result > 0 && o.result == valveList.qty) {
// possibleStock.push({
//   name: o.name,
//   postInv:
//     o.invqty > o.totalreqqty
